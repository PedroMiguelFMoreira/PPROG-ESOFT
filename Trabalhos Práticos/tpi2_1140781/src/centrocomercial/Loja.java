...
/**
 * Representa  um id, uma descrição, uma área e o rendimento do ano anterior de
 * uma loja.
 *
 * @author Pedro
 */
public abstract class Loja {
     ...
     */
    private static double valorRenda = 500;
     ...
     *
     * @return �?rea da loja em metros quadrados.
     */
    public int getArea() {
        return this.area;
    }
    ...
    /**
     * Devolve o valor da renda fixa pago por algumas lojas.
     *
     * @return Valor da renda fixa pago por algumas lojas.
     */
    public static double getValorRenda() {
        return Loja.valorRenda;
    }
    ...
    /**
     * Modifica o valor da renda fixa pago por algumas lojas.
     *
     * @param novoValorRenda O novo valor da renda fixa pago por algumas lojas.
     */
    public static void setValorRenda(double novoValorRenda) {
        Loja.valorRenda = novoValorRenda;
    }
